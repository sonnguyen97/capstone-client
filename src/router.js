...
const routes = [
  ...
  {
    path: '/emailflow',
    component: loadable(() => import('pages/emailFlow/home')),
    exact: true,
  },
  {
    path: '/emailflow/create',
    component: loadable(() => import('pages/emailFlow/edit-page')),
    exact: true,
  },
  {
    path: '/emailflow/edit/:id',
    component: loadable(() => import('pages/emailFlow/edit-page')),
    exact: true,
  },
  ...
  {
    path: '/campaign/home',
    component: loadable(() => import('pages/campaign/home')),
    exact: true,
  },
  {
    path: '/campaign/edit',
    component: loadable(() => import('pages/campaign/edit-page')),
    exact: true,
  },
  // {
  //   path: '/campaign/edit/:id',
  //   component: loadable(() => import('pages/campaign/campaign-edit-page')),
  //   exact: true,
  // },
  {
    path: '/email/design',
    component: loadable(() => import('pages/emailContent')),
    exact: true,
  },
  ...
  {
    path: '/newsletter',
    component: loadable(() => import('pages/newsletter/home')),
    exact: true,
  },
  {
    path: '/newsletter/create/',
    component: loadable(() => import('pages/newsletter/edit-page')),
    exact: true,
  },
  {
  ...
  // Subscriber Pages
  {
    ...
    component: loadable(() => import('pages/subscriber/unsubscribe')),
    exact: true,
  },
  ...
  {
    path: '/subscriber/audiences',
    component: loadable(() => import('pages/subscriber/audiences')),
    exact: true,
  },
  {
    path: '/subscriber/subscribers',
    component: loadable(() => import('pages/subscriber/subscribers')),
    exact: true,
  },
  {
    path: '/subscriber/audiences/create-audience',
    component: loadable(() => import('pages/subscriber/audiences/create-audience')),
    exact: true,
  },
  ...
  {
    path: '/admin',
    component: loadable(() => import('pages/adminAccount/home')),
  },
  {
    path: '/subscriber/excel',
    component: loadable(() => import('pages/subscriber/excel')),
    exact: true,
  },
  {
    path: '/subscriber/audiences/detail',
    component: loadable(() => import('pages/subscriber/audiences/audience-detail')),
    exact: true,
  },
  {
    path: '/subscriber/subscribers/detail',
    component: loadable(() => import('pages/subscriber/subscribers/detail')),
    exact: true,
  },
  {
    path: '/subscriber/audiences/edit',
    component: loadable(() => import('pages/subscriber/audiences/edit-audience')),
    exact: true,
  },
  {
    path: '/automated-campaign/create',
    component: loadable(() => import('pages/campaign/create-automated-campaign')),
    exact: true,
  },
  {
    path: '/campaign/create',
    component: loadable(() => import('pages/campaign/home/create-campaign')),
    exact: true,
  },
  {
...
class Router extends React.Component {
  render() {
    ...
    console.log('ROUTER.JS PROPS', this.props)
    return (
